...
func TestGWSetCRDTOverPubSub(t *testing.T) {
	...
	gsArr, err := createFullyConnectedPubSubMWIPNS(reader, 2, graphID)
	if err != nil {
		t.Fatal(err)
	}
	BaseTestGWSetCRDT(t, gsArr)
...
func BaseTestGWSetCRDT(t *testing.T, gsArr []gsync.GossipMultiWriterIPNS) {
